...
button_1 = tk.Button(master=frame, text='7', padx=15, pady=5, width=3, command=lambda: myclick(7))
button_1.grid(row=1, column=0, pady=2)

button_2 = tk.Button(master=frame, text='8', padx=15, pady=5, width=3, command=lambda: myclick(8))
button_2.grid(row=1, column=1, pady=2)

button_3 = tk.Button(master=frame, text='9', padx=15, pady=5, width=3, command=lambda: myclick(9))
...
button_7 = tk.Button(master=frame, text='1', padx=15, pady=5, width=3, command=lambda: myclick(1))
button_7.grid(row=3, column=0, pady=2)

button_8 = tk.Button(master=frame, text='2', padx=15, pady=5, width=3, command=lambda: myclick(2))
button_8.grid(row=3, column=1, pady=2)

button_9 = tk.Button(master=frame, text='3', padx=15, pady=5, width=3, command=lambda: myclick(3))
